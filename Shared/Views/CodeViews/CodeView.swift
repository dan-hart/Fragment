    ...
    var body: some View {
        ScrollView([.horizontal, .vertical]) {
            ScrollViewReader { reader in
                CodeEditor(source: $sourceCode, language: CodeEditor.Language(rawValue: gist.fileExtension ?? ""), theme: theme, fontSize: $sessionHandler.fontSize, flags: .defaultEditorFlags, indentStyle: .system, autoPairs: nil, inset: nil)
                    .onAppear {
